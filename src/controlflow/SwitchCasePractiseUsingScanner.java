...
public class SwitchCasePractiseUsingScanner {       // switch case usually use when variable has individual condition distinguish
                                             // each other
    public static void main(String[] args) {
        ...
        switch (monthSerial) {
            ...
            case 1:
                monthName = "January";
                break;            // Break is a keyword in java which break the execution of code in java.
            case 2:
                monthName = "February";
                break;
            case 3:
